...
public class TestConfig{
    ...
    public static String from = "ewelinaszymaniak@gmail.com";
    public static String password = "Selenium@123";
    public static String[] to ={"ewelinaszymaniak@gmail.com","trainer@way2automation.com"};
    ...
    public static String mysqlurl = "jdbc:mysql://localhost:3306/10th2021";
